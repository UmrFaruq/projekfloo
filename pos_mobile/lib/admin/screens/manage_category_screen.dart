...
class _ManageCategoryScreenState extends State<ManageCategoryScreen> {
  ...
  Future<void> _saveCategory(String name, {dynamic id}) async {
    try {
      if (id == null) {
        await supabase.from('ms_category_product').insert({
          'category_name': name,
        ...
        await AuditService.logActivity(
          action: 'ADD CATEGORY',
          detail: 'Menambahkan kategori $name',
          type: 'create',
        ...
        await AuditService.logActivity(
          ...
          detail: 'Mengubah kategori menjadi $name',
          type: 'update',
          userId: SessionService.userId,
        );
  ...
  Future<void> _deleteCategory(dynamic id) async {
    try {
      final category = categories.firstWhere((e) => e['id'] == id);
      ...
      await AuditService.logActivity(
        ...
        detail: 'Menghapus kategori ${category['category_name']}',
        type: 'delete',
        userId: SessionService.userId,
      );
      ...
      _showSnackBar("Gagal menghapus kategori.", isError: true);
    }
  }
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  await _saveCategory(
                    nameController.text,
                    id: isEdit ? kategoriLama['id'] : null,
                  );
                },
                child: const Text(
                  "Simpan Kategori",
  ...
  Widget build(BuildContext context) {
    ...
    final filteredCategories = categories.where((cat) {
      return cat['category_name'].toString().toLowerCase().contains(
  ...
  void _showDeleteDialog(Map<String, dynamic> cat) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          "Yakin mau menghapus '${cat['category_name']}'?",
          style: const TextStyle(color: Colors.black87),
        ),
        actions: [
          TextButton(
