...
class _ManagePaymentScreenState extends State<ManagePaymentScreen> {
  ...
  Future<void> _savePayment(String name, {String? id}) async {
    try {
      if (id == null) {
        await supabase.from('ms_payment_method').insert({
          'method_name': name,
        ...
        await AuditService.logActivity(
          ...
          detail: "Menambahkan metode pembayaran $name",
          type: "create",
        );
        ...
        await AuditService.logActivity(
          ...
          detail: "Mengupdate metode pembayaran $name",
          type: "update",
        );
  ...
  Future<void> _deletePayment(String id, String name) async {
    try {
      await supabase
          .from('ms_payment_method')
          .update({
      ...
      await AuditService.logActivity(
        ...
        detail: "Menghapus metode pembayaran $name",
        type: "delete",
      );
                    ...
                    trailing: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              _showDeleteDialog(p['id'], p['method_name']),
                        ),
                      ],
                    ),
                  ),
