    ...
    pdf.addPage(
      pw.Page(
        pageFormat: PdfPageFormat
            .roll80, // Ukuran kertas struk kasir (Printer Thermal 80mm)
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(getDate(), style: const pw.TextStyle(fontSize: 10)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Plg:", style: const pw.TextStyle(fontSize: 10)),
                  pw.Text(
                    widget.customer.isEmpty ? "Umum" : widget.customer,
                    style: const pw.TextStyle(fontSize: 10),
                  ),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Byr:", style: const pw.TextStyle(fontSize: 10)),
                  pw.Text(
                    ...
                    pw.Row(
                      ...
                      children: [
                        ...
                        pw.Expanded(
                          ...
                          child: pw.Text(
                            formatRupiah(
                              entry.value['qty']! * entry.value['price']!,
                            ),
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Tax (12%)", style: const pw.TextStyle(fontSize: 10)),
                  pw.Text(
                    formatRupiah(getTax()),
                    style: const pw.TextStyle(fontSize: 10),
                  ),
              ...
              if (widget.paymentMethod == "cash" &&
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      formatRupiah(widget.amountPaid!),
                      style: const pw.TextStyle(fontSize: 10),
                    ),
                  ],
                ),
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      formatRupiah(widget.amountPaid! - getTotal()),
                      style: const pw.TextStyle(fontSize: 10),
                    ),
                  ],
                ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      onPressed:
                          _printReceipt, // 🔥 MANGGIL FUNGSI PDF PRINTING 🔥
                      label: const Text(
                        "Print Struk",
                        style: TextStyle(
                          color: AppColors.primary,
